...
namespace Mvc5Project.Controllers
{
    ...
    public class AccountController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (custEmail == null && custUserName == null)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        SendEmail("ConfirmEmail", "Account", user, model.RegisterEmail, "WelcomeEmail", "Confirm your account");
                ...
                using (SqlDataReader reader = cmd.ExecuteReader())
                {
                    if (reader.HasRows)
                    {
                        ...
                        if (reader.Read())
                        {
                            ...
                            codeType = "EmailConfirmation";
                             SendEmail("ConfirmEmail", "Account", user, res, "WelcomeEmail", "Confirm your account");
                        }
                        myConnection.Close();
                    }
                }
        ...
        public void SendEmail(string actionName, string controllerName, ApplicationUser user, string email, string emailTemplate, string emailSubject)
        {
            string code = null;
            ...
            MessageServices.SendEmailAsync(email, emailSubject, message);
        }
            ...
            if (ModelState.IsValid)
            {
                ...
                if (custEmail == null && custUserName == null)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        {
                            codeType = "EmailConfirmation";
                             SendEmail("ConfirmEmail", "Account", user, model.Email, "WelcomeEmail", "Confirm your account");
                            return RedirectToAction("ConfirmationEmailSent", "Account");
                        }
                    }
                    AddErrors(result);
        ...
        public static int UpdateEmailLinkDate(string username)
        {
            ...
            command = "UPDATE AspNetUsers SET EmailLinkDate = '" + sqlFormattedDate + "' WHERE UserName = @UserName";
            parameterName = "@UserName";
        ...
        public static int UpdateLastLoginDate(string username)
        {
            DateTime myDateTime = DateTime.Now;
            string sqlFormattedDate = myDateTime.ToString("yyyy-MM-dd HH:mm:ss.fff");
            command = "UPDATE AspNetUsers SET LastLoginDate = '" + sqlFormattedDate + "' WHERE UserName = @UserName";
            parameterName = "@UserName";
            return UpdateDatabase(username);
        }
